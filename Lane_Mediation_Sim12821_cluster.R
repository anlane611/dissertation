...
if(length(args)==0){
  ...
  med_pi <- 2          #which cell type is mediator
...
# n_sim <- 5          #number of replicates in this script
# i_seed <- 1          #seed that changes for each replicate for new observed data
# myseed <- 123        #seed for selecting CpG sites, mediating sites, mediating cell types
# 
# Nsample <- 500       #total sample size
...
filename1 <- paste0("EM_Ncell",Ncell,"_Nmed",med_num_cell,"_medpi",med_pi,"_Nmedsites",med_num_M,"_theta",theta_effect,"_",i_seed)
filename2 <- paste0("TCASig_Ncell",Ncell,"_Nmed",med_num_cell,"_medpi",med_pi,"_Nmedsites",med_num_M,"_theta",theta_effect,"_",i_seed)
filename3 <- paste0("TCAAvgRank_Ncell",Ncell,"_Nmed",med_num_cell,"_medpi",med_pi,"_Nmedsites",med_num_M,"_theta",theta_effect,"_",i_seed)
