...
getpvalmat <- function(folder,Ncell,medpi,Nsam,method,sigma,tau,gammadenom){
  ...
  alpha <- ifelse(method=="MICS_Pvals",0.05,.025/Ncell)
...
gettabmat2 <- function(Ncell,noise){
  sam <- c(200,500,1000)
  ...
  for(k in sam){
    for(i in 1:Ncell){
      for(j in methods){
        mymat[seq(which(methods==j),Ncell*length(methods),length(methods))[i],(which(sam==k)*Ncell-(Ncell-1)):(Ncell*which(sam==k))] <- colSums(getpvalmat("ROC_042221",Ncell,i,k,
                                         j,noise,noise,2)$binmat)
      }
    }
  }
  return(mymat)
...
tabmat2 <- rbind(gettabmat2(2,0.1),gettabmat2(2,1))
...
tabmat3 <- rbind(gettabmat2(3,0.1),gettabmat2(3,1))
...
tabmat4 <- rbind(gettabmat2(4,0.1),gettabmat2(4,1))
...
makeroc("ROC_042221",2,1,200,0.1,0.1,leg=TRUE,title="N=200,cell 1 mediator")
makeroc("ROC_042221",2,2,200,0.1,0.1,title="N=200,cell 2 mediator")
makeroc("ROC_042221",2,1,500,0.1,0.1,title="N=500,cell 1 mediator")
makeroc("ROC_042221",2,2,500,0.1,0.1,title="N=500,cell 2 mediator")
makeroc("ROC_042221",2,1,1000,0.1,0.1,title="N=1000,cell 1 mediator")
makeroc("ROC_042221",2,2,1000,0.1,0.1,title="N=1000,cell 2 mediator")


```
**Figure 1**: 2 cell types, Low noise (sigma=tau=0.1)
...
par(mfrow=c(3,2), mai=c(0.1,0.1,0.1,0))
makeroc("ROC_042221",2,1,200,1,1,leg=TRUE,title="N=200,cell 1 mediator")
makeroc("ROC_042221",2,2,200,1,1,title="N=200,cell 2 mediator")
makeroc("ROC_042221",2,1,500,1,1,title="N=500,cell 1 mediator")
makeroc("ROC_042221",2,2,500,1,1,title="N=500,cell 2 mediator")
makeroc("ROC_042221",2,1,1000,1,1,title="N=1000,cell 1 mediator")
makeroc("ROC_042221",2,2,1000,1,1,title="N=1000,cell 2 mediator")

```
**Figure 2**: 2 cell types, High noise (sigma=tau=1)


```{r 3cellROCsmallsd, echo=FALSE, results='hide'}
par(mfrow=c(3,3), mai=c(0.1,0.1,0.1,0))
makeroc("ROC_042221",3,1,200,0.1,0.1,leg=TRUE,title="N=200,cell 1 mediator")
makeroc("ROC_042221",3,2,200,0.1,0.1,title="N=200,cell 2 mediator")
makeroc("ROC_042221",3,3,200,0.1,0.1,title="N=200,cell 3 mediator")
makeroc("ROC_042221",3,1,500,0.1,0.1,title="N=500,cell 1 mediator")
makeroc("ROC_042221",3,2,500,0.1,0.1,title="N=500,cell 2 mediator")
makeroc("ROC_042221",3,3,500,0.1,0.1,title="N=500,cell 3 mediator")
makeroc("ROC_042221",3,1,1000,0.1,0.1,title="N=1000,cell 1 mediator")
makeroc("ROC_042221",3,2,1000,0.1,0.1,title="N=1000,cell 2 mediator")
makeroc("ROC_042221",3,3,1000,0.1,0.1,title="N=1000,cell 3 mediator")

```
**Figure 3**: 3 cell types, Low noise (sigma=tau=0.1)

```{r 3cellROCbigsd, echo=FALSE, results='hide'}
par(mfrow=c(3,3), mai=c(0.1,0.1,0.1,0))
makeroc("ROC_042221",3,1,200,1,1,leg=TRUE,title="N=200,cell 1 mediator")
makeroc("ROC_042221",3,2,200,1,1,title="N=200,cell 2 mediator")
makeroc("ROC_042221",3,3,200,1,1,title="N=200,cell 3 mediator")
makeroc("ROC_042221",3,1,500,1,1,title="N=500,cell 1 mediator")
makeroc("ROC_042221",3,2,500,1,1,title="N=500,cell 2 mediator")
makeroc("ROC_042221",3,3,500,1,1,title="N=500,cell 3 mediator")
makeroc("ROC_042221",3,1,1000,1,1,title="N=1000,cell 1 mediator")
makeroc("ROC_042221",3,2,1000,1,1,title="N=1000,cell 2 mediator")
makeroc("ROC_042221",3,3,1000,1,1,title="N=1000,cell 3 mediator")

```
**Figure 4**: 3 cell types, High noise (sigma=tau=1)


```{r 4cellROCsmallsd, echo=FALSE, results='hide'}
par(mfrow=c(3,4), mai=c(0.1,0.1,0.1,0))
makeroc("ROC_042221",4,1,200,0.1,0.1,leg=TRUE,title="N=200,cell 1 mediator")
makeroc("ROC_042221",4,2,200,0.1,0.1,title="N=200,cell 2 mediator")
makeroc("ROC_042221",4,3,200,0.1,0.1,title="N=200,cell 3 mediator")
makeroc("ROC_042221",4,4,200,0.1,0.1,title="N=200,cell 4 mediator")
makeroc("ROC_042221",4,1,500,0.1,0.1,title="N=500,cell 1 mediator")
makeroc("ROC_042221",4,2,500,0.1,0.1,title="N=500,cell 2 mediator")
makeroc("ROC_042221",4,3,500,0.1,0.1,title="N=500,cell 3 mediator")
makeroc("ROC_042221",4,4,500,0.1,0.1,title="N=500,cell 4 mediator")
makeroc("ROC_042221",4,1,1000,0.1,0.1,title="N=1000,cell 1 mediator")
makeroc("ROC_042221",4,2,1000,0.1,0.1,title="N=1000,cell 2 mediator")
makeroc("ROC_042221",4,3,1000,0.1,0.1,title="N=1000,cell 3 mediator")
makeroc("ROC_042221",4,4,1000,0.1,0.1,title="N=1000,cell 4 mediator")

```
**Figure 5**: 4 cell types, Low noise (sigma=tau=0.1)


```{r 4cellROCbigsd, echo=FALSE, results='hide'}
par(mfrow=c(3,4), mai=c(0.1,0.1,0.1,0))
makeroc("ROC_042221",4,1,200,1,1,leg=TRUE,title="N=200,cell 1 mediator")
makeroc("ROC_042221",4,2,200,1,1,title="N=200,cell 2 mediator")
makeroc("ROC_042221",4,3,200,1,1,title="N=200,cell 3 mediator")
makeroc("ROC_042221",4,4,200,1,1,title="N=200,cell 4 mediator")
makeroc("ROC_042221",4,1,500,1,1,title="N=500,cell 1 mediator")
makeroc("ROC_042221",4,2,500,1,1,title="N=500,cell 2 mediator")
makeroc("ROC_042221",4,3,500,1,1,title="N=500,cell 3 mediator")
makeroc("ROC_042221",4,4,500,1,1,title="N=500,cell 4 mediator")
makeroc("ROC_042221",4,1,1000,1,1,title="N=1000,cell 1 mediator")
makeroc("ROC_042221",4,2,1000,1,1,title="N=1000,cell 2 mediator")
makeroc("ROC_042221",4,3,1000,1,1,title="N=1000,cell 3 mediator")
makeroc("ROC_042221",4,4,1000,1,1,title="N=1000,cell 4 mediator")

```
**Figure 6**: 4 cell types, High noise (sigma=tau=1)
...
\newpage
\section{Older results for reference}

Results before I corrected the data generation process (small noise: sigma=tau=0.1)

```{r type1plot, echo=FALSE, results='hide', eval=FALSE}

tab.2 <- rbind(tabmat.2cells[1:5,c(2,4,6)],
               setNames(tabmat.2cells[6:10,c(1,3,5)], names(tabmat.2cells[6:10,c(2,4,6)])))/100
tab.3 <- type1tab(tabmat.3cells)
tab.4 <- type1tab(tabmat.4cells)
...
par(mfrow=c(3,3), mai=c(0.3,0.3,0.15,0))
powerplot(200,2,tabmat.2cells,ylab=TRUE,yax=TRUE,text=TRUE,title=TRUE)
powerplot(500,2,tabmat.2cells,title=TRUE)
powerplot(1000,2,tabmat.2cells,title=TRUE)
powerplot(200,3,tabmat.3cells,yax=TRUE,ylab=TRUE)
powerplot(500,3,tabmat.3cells)
powerplot(1000,3,tabmat.3cells)
powerplot(200,4,tabmat.4cells,xlab=TRUE,yax=TRUE,ylab=TRUE)
powerplot(500,4,tabmat.4cells,xlab=TRUE)
powerplot(1000,4,tabmat.4cells,xlab=TRUE)
